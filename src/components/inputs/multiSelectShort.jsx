...
// Multi select que no muestra los elementos seleccinados en la perte de el Buscador, preferentemente para busquedas de lementos largos o de mucha cantidad de elementos
...
const ComponentMultiShort = () => {
  const [value, setValue] = useState([]);

  const options = [
    { label: 'Sol', value: 'Sol aeropuerto camisa verde' },
    { label: 'Arena', value: 'Arena aeropuerto camisa verde' },
    { label: 'Playa', value: 'Playa aeropuerto camisa verde' },
    { label: 'Mar', value: 'Mar aeropuerto camisa verde' },
  ];
...
export default ComponentMultiShort;
